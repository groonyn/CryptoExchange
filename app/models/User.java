...
import models.coin.account.TradeAccount;
...
public class User extends AppModel implements Subject {
	...
	public static User create(final AuthUser authUser) {
		...
		if (authUser instanceof UsernamePasswordAuthUser) {
			final UsernamePasswordAuthUser usernamePasswordAuthUser = (UsernamePasswordAuthUser) authUser;
			user.password = usernamePasswordAuthUser.getPassword();
		}
		...
		if (a == null) {
			if (create) {
				...
				throw new RuntimeException(
						"TradeAccount not enabled for password usage");
			}
		}
